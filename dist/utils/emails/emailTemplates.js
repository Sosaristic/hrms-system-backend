...
exports.changeToAdminTemplate =
  exports.rejectionLetterTemplate =
...
var resetPasswordTemplate = function (payload) {
  var html = "\n    <p>Hello "
    ...
    .concat(
      payload.link,
      '" style="display: inline-block; background-color: #007bff; color: #fff; margin-bottom: 0.5rem; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Reset Password</a>\n        <br/>\n        <b>Please note this link is valid for ',
    )
    .concat(
      payload.duration,
...
var offerLetterTemplate = function (payload) {
  var html = '\n  <p style="font-size:1.5rem">Dear '
    .concat(
      payload.name,
      ",</p>\n\n  <p>\n  We are thrilled to extend a formal offer of employment to you for the position of ",
    )
    .concat(payload.jobTitle, " at ")
    .concat(
      payload.companyName,
      '. Your exceptional qualifications and experience have impressed us, and we believe you will be a valuable addition to our team.\n  </p> \n   <p>To accept this offer, please click on the following link within the next two weeks: <a href="',
    )
    .concat(
      payload.registerLink,
    ...
    .concat(payload.companyName, ' at <a href="mail:')
    .concat(payload.companyEmail, '">')
    .concat(
      payload.companyEmail,
      "</a>.\n   </p>\n  \n  <p>We are excited about the prospect of having you on board and look forward to your positive response.</p> \n  \n  <p>Welcome to ",
    )
    .concat(payload.companyName, "!</p> \n  \n  <p>Sincerely,</p> \n  \n  <p>")
    .concat(payload.companyName, "</p>\n  <p>")
    .concat(payload.companyEmail, "</p>\n  \n  ");
  return html;
};
...
var changeToAdminTemplate = function (payload) {
  var html = "Dear "
    ...
    .concat(
      payload.link,
      '" style="display: inline-block; background-color: #007bff; color: #fff; margin-bottom: 0.5rem; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Click here</a>\n  <br/>\n\n  <p>if the reset button does not work here is the direct link</>\n  <a href="',
    )
    .concat(payload.link, '">')
    .concat(
      payload.link,
