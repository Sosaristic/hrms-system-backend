...
exports.deleteFromCloudinry = exports.uploadToCloudinary = exports.verifyJwt = exports.createJwt = exports.comparePassword = exports.hashPassword = exports.authentication = exports.generateSessionToken = exports.generateSalt = exports.generateHash = exports.generateRandomString = void 0;
...
var hashPassword = function (password) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bcrypt_1.default.genSalt(Number(process.env.SALT))];
            case 1:
                salt = _a.sent();
...
var createJwt = function (user, options) {
    var token = jsonwebtoken_1.default.sign({ userId: user.userId, role: user.role }, process.env.JWT_SECRET, options);
    return token;
};
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, cloudinary_1.v2.uploader.upload(file, {
                            folder: folder,
                            resource_type: "raw",
                        })];
                case 1:
...
var deleteFromCloudinry = function (url) { return __awaiter(void 0, void 0, void 0, function () {
