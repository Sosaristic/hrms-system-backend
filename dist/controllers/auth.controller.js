...
// login
exports.authRegister = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          (_a = auth_validators_1.registerBodySchema.parse(req.body)),
            (name = _a.name),
            (email = _a.email),
            (password = _a.password);
          return [
            4 /*yield*/,
            users_model_1.UserModel.findOne({ email: email }),
          ];
        case 1:
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            users_model_1.UserModel.create({
              name: name,
              email: email,
        ...
        case 3:
          ...
          link = ""
            .concat(process.env.SERVER_URL, "/api/v1/auth/confirm/admin?token=")
            .concat(token);
          subject = "Change to Admin";
          html = (0, emailTemplates_1.changeToAdminTemplate)({
            name: user.name,
            link: link,
          });
          (0, sendEmail2_1.sendEmail)({
            email: user.email,
            subject: subject,
            html: html,
          });
...
exports.confirmAdmin = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            users_model_1.UserModel.findOneAndUpdate(
              { _id: decode.userId },
              {
              ...
              .send(
                "<h2>Hi "
                  ...
                  .concat(
                    ...
                    '/login" style="display: inline-block; background-color: #007bff; color: #fff; margin-bottom: 0.5rem; padding: 10px 20px; text-decoration: none; border-radius: 5px;">Login</a>\n    ',
                  ),
              ),
          ];
      }
...
exports.authLogin = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var data,
      email,
      password,
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            users_model_1.UserModel.findOne({ email: email }).select(
              "+password",
            ),
          ];
        case 1:
          ...
          return [
            4 /*yield*/,
            (0, helpers_1.comparePassword)(password, user.password),
          ];
        case 2:
          isMatch = _a.sent();
          if (!isMatch) {
        ...
        case 3:
          ...
          return [
            2 /*return*/,
            res.status(201).json({ status: "success", user: userData }),
          ];
      }
    });
  });
...
//
exports.getToken = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            users_model_1.UserModel.findOne({ _id: decoded.userId })
              .select("+refreshToken")
              .lean(),
          ];
        case 1:
...
exports.forgetPassword = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 1:
          ...
          link = ""
            .concat(process.env.CLIENT_URL, "/reset-password/?token=")
            .concat(token);
...
exports.confirmPasswordReset = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var tokenParams,
      _a,
      token,
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          (_a = auth_validators_1.passwordResetSchema.parse(
            __assign({ token: tokenParams }, req.body),
          )),
            (token = _a.token),
            (password = _a.password);
          decode = (0, helpers_1.verifyJwt)(token);
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            users_model_1.UserModel.findOne({ _id: decode.userId }),
          ];
        case 2:
          user = _b.sent();
          if (!user) {
          ...
          user.save();
          html = (0, emailTemplates_1.resetSuccessTemplate)({
            name: user.name,
          });
