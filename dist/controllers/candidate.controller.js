...
exports.deleteCandidate =
  ...
  exports.acceptCandidate =
  exports.singleCandidate =
  exports.allCandidate =
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            candidate_model_1.CandidateModel.create({
              name: name,
              email: email,
              job: job,
...
exports.allCandidate = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            candidate_model_1.CandidateModel.find({})
...
exports.singleCandidate = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, candidate;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            candidate_model_1.CandidateModel.findOne({ _id: id }).populate(
              "job",
            ),
          ];
        case 1:
...
exports.acceptCandidate = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            candidate_model_1.CandidateModel.findOneAndUpdate(
              { _id: id },
        ...
        case 1:
          ...
          link = ""
            .concat(process.env.CLIENT_URL, "/employee/register/?id=")
            .concat(candidate._id);
...
exports.rejectCandidate = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
...
exports.deleteCandidate = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, candidate;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            candidate_model_1.CandidateModel.findOneAndDelete({ _id: id }),
          ];
        case 1:
          candidate = _a.sent();
          if (!candidate) {
