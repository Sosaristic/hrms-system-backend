...
exports.getUsersBySessionToken =
        ...
        case 1:
          ...
          mailOptions = {
            ...
            html: "\n        <p>Hello "
              ...
              .concat(process.env.CLIENT_URL, "/reset-password/")
              .concat(
                token,
