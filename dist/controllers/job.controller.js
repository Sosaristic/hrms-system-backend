...
exports.addJob = (0, tryCatch_1.tryCatch)(function (req, res) {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            department_model_1.DepartmentModel.findOne({ name: dept }),
          ];
        case 1:
...
exports.allJobs = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var page, limit, jobs;
    return __generator(this, function (_a) {
      switch (_a.label) {
...
exports.singleJob = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, job;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            job_model_1.JobModel.findOne({ _id: id }).populate("department"),
          ];
        case 1:
          job = _a.sent();
          if (!job) {
...
exports.changeJobStatus = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, status, job;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            job_model_1.JobModel.findOneAndUpdate(
              { _id: id },
              { $set: { status: status } },
              { new: true },
            ).exec(),
        ...
        case 1:
          ...
          if (!job) {
            throw new CustomError_1.default(
              "Sorry, Error Occur while updating job Status",
              404,
            );
          }
          return [
...
exports.deleteJob = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, job;
    return __generator(this, function (_a) {
      switch (_a.label) {
