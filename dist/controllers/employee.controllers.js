...
exports.registerEmployee = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          (_a = employee_validators_1.addEmployeeSchema.parse(req.body)),
            (candidateId = _a.candidateId),
            (gender = _a.gender),
            (image = _a.image),
            (password = _a.password);
          return [
            4 /*yield*/,
            candidate_model_1.CandidateModel.findOne({
              _id: candidateId,
        ...
        case 4:
          ...
          return [
            4 /*yield*/,
            employee_model_1.EmployeeModel.create({
              user: user,
              gender: gender,
...
exports.allEmployee = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            employee_model_1.EmployeeModel.find({})
              .populate({
...
exports.singleEmployee = (0, tryCatch_1.tryCatch)(function (req, res) {
  return __awaiter(void 0, void 0, void 0, function () {
    var id, employee;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            employee_model_1.EmployeeModel.findOne({ _id: id })
              .populate({
                path: "user job department",
              })
              .exec(),
